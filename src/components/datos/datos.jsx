...
export const products = [
  ...
  { id: "4", name: "Impresora Magna", category: "impresoras",description: "Impresora 3d Hellbot Magna Se Fdm 23x23 Extrusor Directo", price: " 48000 ", image:img0, stock:7, initial: 1},
  { id: "5", name: "Pack Pla", category: "insumos",description: "Combo 6 kg Filamento Recarga para Impresora 3D PLA Hellbot ECOFILA 1.75mm", price: " 7980 ", image:img4, stock:15, initial: 1},
  { id: "6", name: "Pack Recarga", category: "insumos", description: "Opción RECARGA. Misma calidad, mismo producto a un precio menor..", price: " 2000 ", image:img5, stock:4, initial: 1},
  { id: "7", name: "Extrusor", category: "insumos",description: "Kit Extrusor Bowden Mk8 Dura Aluminio Para Impresora 3d 1.75mm Derecha", price: " 3000 " , image:img6, stock:10, initial: 1},
